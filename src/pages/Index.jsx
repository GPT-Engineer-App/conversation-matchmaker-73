    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex flex-1 p-4">
        ...
        <div className="w-[25%] mr-4 space-y-4">
          <Card className="p-4 shadow-lg bg-white rounded-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-xl" style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1), 0 5px 15px rgba(0, 0, 0, 0.1)' }}>
          ...
          <Card className="p-4 shadow-lg bg-white rounded-lg space-y-4 transform hover:scale-105 transition-transform duration-300 hover:shadow-xl" style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1), 0 5px 15px rgba(0, 0, 0, 0.1)' }}>
            <div>
